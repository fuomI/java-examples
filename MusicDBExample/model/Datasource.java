...
//    INNER JOIN artists ON albums.artis = artists._id ORDER BY artists.name,
//    albums.name, songs.track
    public static final String CREATE_ARTIST_FOR_SONG_VIEW = "CREATE VIEW IF NOT EXISTS " +
            TABLE_ARTIST_SONG_VIEW + " AS SELECT " + TABLE_ARTISTS + "." +
            COLUMN_ARTIST_NAME + ", " + TABLE_ALBUMS + "." + COLUMN_ALBUM_NAME + " AS album, " +
...
//        }
    ...
    // Uses prepared statement to stop SQL injection attack
